...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug  6 03:25:29 2022
...
#        yol_ayrimi = cv2.dilate(yol_ayrimi, kernel, iterations=1)
        ...
        if sag_qtr>950 and sol_qtr<950 and qtr_orta>3000 and qtr_orta<12000:
            if count >=4:
                durum = 3
        ...
        elif sag_qtr<950 and sol_qtr>950 and qtr_orta>3000 and qtr_orta<12000:
            if count >=4:
                durum = 4
